          ...
          <div id="about">
            ...
            <div className="about-section-1 my-5">
              ...
              <div className="right-about">
                ...
                <p>
                  <p className="parahead my-3">
                    {" "}
                    By making renting an apartment as easy as booking a hotel
                  </p>
                  <p className="paratext my-3">
                    From browsing and touring to applying and process of
                    renting, the entire process is becoming faster, easier, and
                    more trustworthy on ROOM
            ...
            <div className="about-section-2 my-5">
              <div className="right-about-2">
                ...
                <p>
                  <p className="parahead my-3">
                    {" "}
                    By connecting them with renters
                  </p>
                  <p className="paratext my-3">
                    We connect property owners and renters directly and so that
                    they can fill more vacancies, more quickly.
                  </p>
                </p>
              </div>

              <div className="left-about-2"></div>
            </div>{" "}
            <br /> <br />
            {/* ------------------------------ */}
            <div className="about-section-3 my-5">
              <div className="left-about-3"></div>
            ...
            <div className="text-container-about-2">
              ...
              exhausting, and slow. We spend hours of our lives searching just
              to settle for places that don’t feel worthy. The nightmare ends
              now. ROOM-ROVER is on a mission to change the way you rent,
              forever. We are building a community for both the owners and
              tenants to make rental experiences easier, faster, and more human.
              By making this vision a reality, we’re creating opportunity for
              everyone to live better—from one fresh start to the next.
            </div>
          </div>
        </div>
      </div>
